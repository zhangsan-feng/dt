import asyncio
from _platform.douyin.api.sign import ms_token
from _platform.douyin.api.sign.a_bogus_tk import ABogus
...
if __name__ == '__main__':
    ...
    asyncio.run(
        douyin_live(
            "7- #在抖音，记录美好生活#【第三片御兔】正在直播，来和我一起支持Ta吧。复制下方链接，打开【抖音】，直接观看直播！ https://v.douyin.com/CAnCqe4r3cI/ 0@8.com :8pm",
            "",
            ""
        )
    )