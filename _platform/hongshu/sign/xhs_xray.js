...
try {
    ...
    require('./sign/xhs_xray_pack1.js');
} catch (e) {
    try {
        require('./_platform/hongshu/sign/xhs_xray_pack1.js');
    } catch (e) {
        require('./_platform/hongshu/sign/xhs_xray_pack1.js');
    }
}
try {
    require('./sign/xhs_xray_pack2.js');
} catch (e) {
    try {
        require('./_platform/hongshu/sign/xhs_xray_pack2.js');
    } catch (e) {
        require('./_platform/hongshu/sign/xhs_xray_pack2.js');
    }
}
