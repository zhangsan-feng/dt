...
async def download_stream(link, file_name, headers):
    ...
    if c.only_download_video and ".mp4" not in file_name: return
    if c.only_download_audio and ".mp3" not in file_name: return
    if c.only_download_image and ".png" not in file_name: return
